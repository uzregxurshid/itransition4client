...
const Register = () => {
  ...
  const handleSubmit = ()=>{
    if (pass===repass){
      ...
      .catch(function (error) {
       alert(error.response.data[0].value+" "+error.response.data[0].msg);
      });
  ...
  return (
    <>
      <section className="vh-max" style={{
        backgroundColor: "#eee"
      }}>
                    ...
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="password" id="form3Example4cd" className="form-control"  onChange={e=>setRepass(e.target.value)}/>
